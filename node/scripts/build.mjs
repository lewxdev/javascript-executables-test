 ...
 * https://nodejs.org/docs/v25.6.1/api/single-executable-applications.html#generating-single-executable-applications-with---build-sea
 *
 * @typedef  {object}                  Config
 * @property {string}                  main                                   Example: '/path/to/bundled/script.js'
 * @property {string}                  [executable]                           Uses the current Node.js binary by default. Example: '/path/to/node/binary'
 * @property {string}                  output                                 Example: '/path/to/write/the/generated/executable'
 * @property {boolean}                 [disableExperimentalSEAWarning=false]
 * @property {boolean}                 [useSnapshot=false]
 * @property {boolean}                 [useCodeCache=false]
 * @property {string[]}                [execArgv]
 * @property {'none'|'env'|'cli'}      [execArgvExtension='env']
 * @property {Object.<string, string>} [assets]
 */

/**
 * @param  {Config}                                    configIn
 * @return {{ configFile: string, configOut: Config }}
 */
function createConfig (configIn) {
  let output = configIn.output;
  if (
    process.platform === 'win32' &&
    !configIn.output.endsWith('.exe')
  ) {
    output = configIn.output + '.exe';
  }
